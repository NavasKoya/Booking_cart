...
//                                 children: [
//                                   Container(
//                                     child: Text('Thu', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 25),),
//                                   ),
//
//                                   Container(
//                                     child: Text(_selectedDays.length.toString(), style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 25),),
//                                   )
//                                 ],
//                               ),
//                             ),
...
//                                   child: Text('${value[index]}', style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold, fontSize: 25),),
//                                 ),
//
//                                 Container(
//                                   decoration: BoxDecoration(
